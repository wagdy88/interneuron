...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 naf2 /home/mohamed/myprojects/interneuron/data/fullCurrents/naf2.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohamed/myprojects/interneuron/data/fullCurrents/naf2.mod";
static const char* nmodl_file_text = 
  "NEURON { SUFFIX naf2  }\n"
