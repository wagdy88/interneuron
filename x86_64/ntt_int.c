...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 it2INT /home/mohamed/myprojects/interneuron/data/fullCurrents/ntt_int.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohamed/myprojects/interneuron/data/fullCurrents/ntt_int.mod";
static const char* nmodl_file_text = 
